...
namespace pkk_5_parser
{
    public class Program
    {
        static void Main(string[] args)
        {
            ...
            //test.Add("77:02:0024001:1026");
            //test.Add("77:02:0024002:1650");
            //test.Add("77:02:0024001:1020");
            //test.Add("77:02:0024001:1043");

            //var val = "Тип:#Здание#Кад. номер:#50:26:0170504:745#Кад. квартал:#77:07:0017001#Статус:#Ранее учтенный#Наименование:#Жилое строение#Адрес:#г. Москва, п. Марушкинское, СПК''Ветераны Победы''вблизи д.Марушкино, стр.на уч.424#Форма собственности:#-#Кадастровая стоимость:#13 224 541,29 руб.#Общая площадь:#250,5 кв. м#Основные характеристики#общая этажность:#2#подземная этажность:#-#материал стен:#площадь застройки:#-#завершение строительства:#2010#ввод в эксплуатацию:#-#Назначение:#Жилой дом#Кадастровый инженер:#Кривицкая Наталья Александровна#Дата постановки на учет:#08.01.2013#Дата изменения сведений в ГКН:#31.08.2017#Дата выгрузки сведений из ГКН:#31.08.2017";
            //var cad = "50:54:0020103:72";
            //OKS oks = new OKS(val, cad);

            string path = @"C:\Users\vtsvetkov\source\repos\pkk_5_parser\pkk_5_parser\resourses\ОКС_вне_БТИ_чист.xlsx";
            int lenghtOfRow = 500;
            int Flows = 6;
            ...
            //parserTest("77:01:0006011:2006", driverPath);

            //IParser parser = new Parser(driverPath, path, 4, lenghtOfRow);
            //parser.RunParsingOKS();
            string numsOfFloors = "17, 19, 8-3-26, 11-14";
